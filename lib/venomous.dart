...
class venomous extends StatefulWidget {
  @override
  _VenomousState createState() => _VenomousState();
}

class _VenomousState extends State<venomous> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        child: ReadMoreText(
                          text:
                              'Venomous is a popular espresso-based coffee beverage that originated in Italy. It is composed of three main ingredients: espresso, steamed milk, and frothed milk.',
                          maxLines: 5,
                        ),
                      ),
                      SizedBox(

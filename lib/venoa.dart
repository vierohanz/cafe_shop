...
class venoa extends StatefulWidget {
  @override
  _VenoaState createState() => _VenoaState();
}

class _VenoaState extends State<venoa> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        child: ReadMoreText(
                          text:
                              'Venoa is a popular espresso-based coffee beverage that originated in Italy. It is composed of three main ingredients: espresso, steamed milk, and frothed milk.',
                          maxLines: 5,
                        ),
                      ),
                      SizedBox(

...
class indiano extends StatefulWidget {
  @override
  _IndianoState createState() => _IndianoState();
}

class _IndianoState extends State<indiano> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        child: ReadMoreText(
                          text:
                              'Indiano is a popular espresso-based coffee beverage that originated in Italy. It is composed of three main ingredients: espresso, steamed milk, and frothed milk.',
                          maxLines: 5,
                        ),
                      ),
                      SizedBox(

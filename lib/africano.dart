...
class africano extends StatefulWidget {
  @override
  _AfricanoState createState() => _AfricanoState();
}

class _AfricanoState extends State<africano> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        child: ReadMoreText(
                          text:
                              'Africano is a popular espresso-based coffee beverage that originated in Italy. It is composed of three main ingredients: espresso, steamed milk, and frothed milk.',
                          maxLines: 5,
                        ),
                      ),
                      SizedBox(
